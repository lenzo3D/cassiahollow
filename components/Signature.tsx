...
const WHATSAPP_TEXT = "Hello, I would like to arrange a private viewing of Cassia Hollow, Belmont Road.";
    ...
    <section ref={rootRef} aria-labelledby="signature-wordmark" className="relative bg-background text-foreground">
      ...
      <div className="px-[6vw] pt-[24vh] md:pt-[28vh]">
        ...
        <p data-fade className={`mt-6 ${label}`}>
          Belmont Road <span aria-hidden="true">·</span> Bukit Timah <span aria-hidden="true">·</span> Singapore
        </p>
      </div>

...
export const CHAPTERS: Chapter[] = [
  {
    ...
    fact: "BELMONT ROAD · BUKIT TIMAH · DISTRICT 10",
  ...
  },
  {
    ...
    fact: "WITHIN 2 KM · SEVERAL ESTABLISHED SCHOOLS",
    src: "/images/location/sji.jpg",
    alt: "The crest and lettering on the white curve of a school façade, in warm afternoon light.",
    position: "50% 50%",
    credit: "A school façade, Singapore",
  },
  {
    id: "gardens",
    n: "03",
    ...
    fact: "12 MIN DRIVE · UNESCO WORLD HERITAGE SITE",
  ...
  },
  {
    ...
    body:
      "With Bukit Timah Road, Dunearn Road, the PIE and Sixth Avenue MRT close by, the address enjoys direct connections to the city and across Singapore.",
    fact: "PIE · BUKIT TIMAH ROAD · DUNEARN ROAD · SIXTH AVENUE MRT",

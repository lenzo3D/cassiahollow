    ...
    <main id="content" className="bg-background text-foreground">
      ...
      <section className="pt-[16vh] md:pt-[22vh]">
        <SectionIntro
          ...
          fact="Freehold · 4,821 sq ft land · District 10"
        />
        <FilmFig
      ...
      <section className="px-[6vw] pt-[16vh] md:pt-[22vh]">
        ...
        <div className="mt-[10vh] md:mt-[12vh]">
          ...
          <p className="mt-3 font-serif text-[clamp(1.75rem,3.2vw,3.25rem)] leading-none tracking-[0.01em] text-foreground">S$19.88M</p>

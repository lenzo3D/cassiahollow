...
export const metadata: Metadata = {
  title: "Virtual Tour",
  description:
    "Stand inside Cassia Hollow before it is built: 360-degree views of the living area, dining area, car porch, master bedroom and master bathroom, reached from the floor plans.",
};

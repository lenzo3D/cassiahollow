...
export const metadata: Metadata = {
  title: "The Residence",
  description:
    "Freehold detached house on Belmont Road, Bukit Timah, District 10. 4,821 sq ft land, 9,462 sq ft built-up, 5+1 bedrooms, 7 bathrooms, 18 m pool, home lift, basement and attic. Brand new; private viewings by appointment.",
};
  ...
  return (
    <main id="content" className="bg-background text-foreground">
      ...
      <section className="px-[6vw] pt-[22vh] md:pt-[26vh]">
        ...
        <p className={`mt-8 max-w-[52ch] ${bodyCls}`}>A new freehold residence on Belmont Road.</p>
      </section>
      <Fig
        className="mt-[10vh] md:mt-[12vh]"
        src="/images/hero-still.jpg"
        alt="Cassia Hollow from the road: the timber-screened house behind its planting."
        caption="Belmont Road"
        offset="right"

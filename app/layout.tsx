...
const DESCRIPTION =
  "A private expression of tropical living. A new freehold detached residence on Belmont Road, Bukit Timah, District 10, Singapore. Private viewings by appointment.";

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: { default: "Cassia Hollow — Belmont Road, Singapore", template: "%s — Cassia Hollow" },
  description: DESCRIPTION,
  // Share cards (WhatsApp, iMessage, LinkedIn…) use app/opengraph-image.jpg,
  // which Next.js picks up by convention.
  openGraph: {
    type: "website",
    siteName: "Cassia Hollow",
    locale: "en_SG",
    url: "/",
    title: "Cassia Hollow — Belmont Road, Singapore",
    description: DESCRIPTION,
  },

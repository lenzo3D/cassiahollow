...
//   ENQUIRY_FROM     optional sender, e.g. "Cassia Hollow <viewings@yourdomain.sg>"
...
const DEFAULT_FROM = "Cassia Hollow <onboarding@resend.dev>";
...
export async function POST(request: Request) {
  ...
  const lines = [
    `Private viewing enquiry — Cassia Hollow, Belmont Road`,
    ``,
    `Name:       ${name}`,
    `Email:      ${email}`,
    `Telephone:  ${phone || "—"}`,

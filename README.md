...
9 Belmont Road, Bukit Timah, District 10, Singapore.
...
Cassia Hollow is a fictional demonstration project built for portfolio purposes.
Its name, address, pricing and stated facts are invented and do not depict any
real property, development, listing or business (see the small print in
`components/Colophon.tsx`). Two photographs on the Location page are Creative
Commons (CC BY-SA) from Wikimedia Commons and are credited in place, with
links, inside `components/locationChapters.ts`.
